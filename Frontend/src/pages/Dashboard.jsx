      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="p-4 md:p-10">
          <div className="px-2 md:px-10 lg:px-20">
            ...
            <div className="w-full bg-slate-200 rounded-2xl shadow-2xl p-6 md:border-l-[10px] border-b-[6px] border-[#2249A3]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
                ...
                <div className="bg-gradient-to-r from-slate-700 to-blue-600 rounded-2xl p-6 md:p-10 cursor-pointer hover:scale-105 transition-all duration-300 shadow-xl flex justify-between items-center text-white">
                  <div>
                ...
                <div className="bg-gradient-to-r from-purple-600 to-indigo-500 rounded-2xl p-6 md:p-10 cursor-pointer hover:scale-105 transition-all duration-300 shadow-xl flex justify-between items-center text-white">
                  <div>
                    <h2 className="text-lg md:text-xl font-semibold font-serif opacity-90 uppercase tracking-widest">
                      Teachers
                    </h2>
