  ...
  return (
    <header className="sticky w-full px-10 py-8 bg-gradient-to-r from-slate-400/60 to-white/50 backdrop-blur-xl shadow-2xl shadow-indigo-900/50 border-r border-none transition-colors font-serif">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center bg-white/50 backdrop-blur-md border border-none rounded-xl px-3 py-2 shadow-2xl focus-within:ring-1 hover:shadow-sky-300 focus-within:ring-indigo-400 transition-all">
